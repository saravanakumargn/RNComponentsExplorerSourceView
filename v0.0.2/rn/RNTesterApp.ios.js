...
import SourceModalView from '../Views/SourceModalView';
...
const Header = ({ onBack, title, openModal }: { onBack?: () => mixed, title: string, openModal?: () => mixed, }) => (
      ...
      if (Component.external) {
        ...
        return (
          <View style={styles.exampleContainer}>
            <Header onBack={this._handleBack} title={Component.title} openModal={this._openModal}/>
            <Modal
