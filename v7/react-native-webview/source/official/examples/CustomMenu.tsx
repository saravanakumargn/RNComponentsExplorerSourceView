...
// EXPLORER ADAPTATION: upstream writes `export default CustomMenu = () => {`,
// an assignment to an undeclared identifier. That only works in sloppy mode;
// this app's modules are strict, so evaluating it threw
// "Property 'CustomMenu' doesn't exist" and took the whole example down.
// Declaring the binding is the minimal fix and changes no behavior.
const CustomMenu = () => {
