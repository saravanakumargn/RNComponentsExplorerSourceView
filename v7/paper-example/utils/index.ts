...
// The outer Expo migration remains on Legacy Architecture. Dynamic Android
// color support is deferred with the original drawer/settings shell.
export const deviceColorsSupported = false;
