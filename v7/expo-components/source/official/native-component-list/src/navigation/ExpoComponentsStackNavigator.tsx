    ...
    <Stack.Navigator
      ...
      <Stack.Screen
        ...
        options={{
          ...
          headerLeft: ({ tintColor }) => <CatalogBackButton color={tintColor} />,
        }}>
        {() => <ExpoComponentsRoot navigation={props.navigation} />}
      </Stack.Screen>
...
function ExpoComponentsRoot({ navigation }: { navigation: BottomTabNavigationProp<any> }) {
  return (
    <View style={{ flex: 1 }}>
      <ExpoCatalogSegmentedControl
        selected="components"
        onSelect={(section) => navigation.navigate(section)}
      />
